...
**Example / 사용 예시:** \`\`\`{ r} library(KSIC) \# Set the default
KSIC revision to the 10th \# 기본 KSIC 차수를 10차로 설정 options(ksic.C
= 10)
...
**Example / 사용 예시:**
`{ r} is_ksic(c("A", "01", "99999", "invalid_code"))`
...
**Example / 사용 예시:**
`{ r} ksic_group(c("31311", "4631", "25", "A"), digit = 2, name = TRUE)`
...
**Example / 사용 예시:**
`{ r} result_list <- ksic_sub(c("26","96","52636"), digit = 4) print(result_list)`
...
**Example / 사용 예시:** \`\`\`{ r} \# Convert 10th revision codes to
11th revision ksic_convert(c(“10110”, “10111”), from_C = 10, to_C = 11)
...
\`\`\`{ r} my_data \<- data.frame( company = c(“A”, “B”, “C”, “D”),
